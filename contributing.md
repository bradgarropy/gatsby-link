...
```bash
git clone https://github.com/<username>/gatsby-link
```
...
[license]: https://github.com/bradgarropy/gatsby-link/blob/master/license
[fork]: https://github.com/bradgarropy/gatsby-link/fork
[contributors]: https://github.com/bradgarropy/gatsby-link#-contributors
